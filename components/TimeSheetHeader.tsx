...
interface TimeSheetHeaderProps {
  ...
  employeeForEdit?: ProfileEditData;
  isAdmin?: boolean;
}

export function TimeSheetHeader({ todayHours, weekHours, employeeName, employeeTitle, employeeForEdit, isAdmin = false }: TimeSheetHeaderProps) {
